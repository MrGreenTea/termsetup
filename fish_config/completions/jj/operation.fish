# ABOUTME: Completions for jj operation subcommand
...
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from restore" --keep-order -f -a "(__fish_jj_complete_operation_ids)" -d 'Operation ID'
complete -c jj -n "__fish_jj_using_subcommand operation; and __fish_seen_subcommand_from undo" --keep-order -f -a "(__fish_jj_complete_operation_ids)" -d 'Operation ID'
