...
install_apps="bat eza zoxide bandwhich ytop fd-find du-dust starship procs sd git-delta git-absorb ripgrep atuin bottom hyperfine nu broot tokei jj-cli"
